  ...
  return (
    <motion.div ref={ref} style={{ y, opacity }} className="max-w-lg p-10 bg-white !text-black mb-10 font-serif">
      ...
      <p className="mt-4 text-xl text-black drop-shadow-sm">
        Explore our unique collection of handmade art and crafts — where creativity meets craftsmanship in every piece.
      </p>
      <button
        onClick={(e) => {
          e.stopPropagation();
...
const Home = () => {
  ...
  return (
    <>
      <div className="pt-8 relative overflow-hidden bg-white sm:p-2 lg:p-8 text-black">
